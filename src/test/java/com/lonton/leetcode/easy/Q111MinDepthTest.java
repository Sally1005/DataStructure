...
/**
 * 示例1：将数组 nums1 = [3,9,20,null,null,15,7] 构建为二叉树，并校验二叉树最小深度是否为 2。
 * <p>
 * 示例2：将数组 nums2 = [2,null,3,null,4,null,5,null,6]构建为二叉树,并校验二叉树最小深度是否为 5。
 * <p>
 * 示例3：将数组 nums3 = [2,null,3,null,4,1,5,null,7]构建为二叉树,并校验二叉树最小深度是否为 4。
 *
 * @author 张利红
 */
