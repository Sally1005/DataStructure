...
public class Q617MergingTreesTest {
    ...
    public void test() {
        ...
        TreeNode<Integer> root1 = TreeNode.arrayToTree(nums1);
    ...
    public void testHalfChildNode() {
        ...
        TreeNode<Integer> root4 = TreeNode.arrayToTree(nums4);
    ...
    public void testFullChildNode() {
        ...
        TreeNode<Integer> root5 = TreeNode.arrayToTree(nums5);
        Integer[] nums6 = new Integer[]{4, 2, 7, 1, 3, 6, 9};
        TreeNode<Integer> root6 = TreeNode.arrayToTree(nums6);
    ...
    public void testNull() {
        ...
        TreeNode<Integer> root7 = TreeNode.arrayToTree(nums7);
        Integer[] nums8 = new Integer[0];
        TreeNode<Integer> root8 = TreeNode.arrayToTree(nums8);
