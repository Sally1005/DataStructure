...
/**
 * 测试将二叉搜索树转换为累加树  <p/>
 * 示例1：将数组 nums = [4,1,6,0,2,5,7,null,null,null,3,null,null,null,8] 构建成二叉树，<p/>
 * 并判断输出的值是否为预期的[30,36,21,36,35,26,15,null,null,null,33,null,null,null,8]。<p/>
 * 示例2：将数组 nums = [1,0,2] 构建成二叉树，并判断输出的值是否为预期的[3,3,2]。<p/>
 * 示例3：将数组 nums = [3,2,4,1] 构建成二叉树，并判断输出的值是否为预期的[7,9,4,10]。
 *
 * @author 张利红
 */
public class Q538ConvertBSTToGreaterTreeTest {
    ...
    public void test() {
        ...
        TreeNode actual = new Q538ConvertBSTToGreaterTree().convertBST(TreeNode.arrayToTree(nums));
