...
public class Q654MaximumBinaryTreeTest {
    ...
    public void testWithSingleNumber() {
        TreeNode<Integer> root = TreeNode.arrayToTree(new Integer[]{1});
    ...
    public void testLeftSubtreeWithLeftBranch() {
        TreeNode<Integer> root = TreeNode.arrayToTree(new Integer[]{5,4,null,2,3});
        Assertions.assertEquals(
                root,
    ...
    public void testRightSubtreeWithRightBranch() {
        TreeNode<Integer> root = TreeNode.arrayToTree(new Integer[]{3,null,2,null,1});
        Assertions.assertEquals(
                root,
    ...
    public void testRightSubtreeWithLeftBranch() {
        TreeNode<Integer> root = TreeNode.arrayToTree(new Integer[]{5,null,4,3,null,2});
        Assertions.assertEquals(
                root,
    ...
    public void testLeftSubtreeWithRightBranch() {
        TreeNode<Integer> root = TreeNode.arrayToTree(new Integer[]{6,5,null,null,4,null,2});
        Assertions.assertEquals(
                root,
    ...
    public void testLeftSubtreeWithRightSubtree() {
        TreeNode<Integer> root = TreeNode.arrayToTree(new Integer[]{6,3,5,null,2,0,null,null,1});
        Assertions.assertEquals(
                root,
